...
<section class="shopping-cart">
    ...
    <h1 class="title">booking cart</h1>
    ...
    <div  class="box">
        ...
        <form action="" method="post">
            ...
            <input type="number" min="1" max="1"value="<?php echo $fetch_cart['quantity']; ?>" name="cart_quantity" class="qty">
    ...
    <div class="cart-total">
        ...
        <a href="shop.php" class="option-btn">anything else</a>
        <a href="checkout.php" class="btn  <?php echo ($grand_total > 1)?'':'disabled' ?>">Confirm Booking ?</a>
    </div>
